import { version, ref, watchEffect, watch, getCurrentInstance, unref, inject, useSSRContext, defineComponent, computed, h, resolveComponent, createApp, effectScope, reactive, mergeProps, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, hasInjectionContext, toRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx, createTextVNode } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as hasProtocol, j as joinURL, p as parseURL, m as parseQuery, n as createHooks, w as withQuery, o as isScriptProtocol, q as withTrailingSlash, r as withoutTrailingSlash, t as sanitizeStatusCode, v as isEqual, x as stringifyParsedURL, y as stringifyQuery } from '../nitro/node-server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-CQBhenrN.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-D8GOYn_V.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0 as a, createError as c, entry$1 as default, useHead as u };
